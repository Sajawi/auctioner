...
To check if a user is currently logged in on the webpage you need to make a get request on http://localhost:3000/data/login and will then get a Boolean message if the user is logged in or not.
